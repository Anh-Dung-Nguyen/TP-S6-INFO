...
int main(int argc, char** argv)
{
    ...
    while (1)
    {
        ...
        ret = recvfrom(sock, buf_read, sizeof(buf_read), 0, (struct sockaddr *)&client, &client_len);
        ...
        while (1)
        {
            ret = sendto(sock, buf_write, sizeof(buf_write), 0, (struct sockaddr *)&client, client_len);
